    ...
    <div class="ae-grid ae-grid--collapse">
        <div class="ae-grid__item item-lg-4 au-xs-ta-center au-lg-ta-left">
            <ul class="rk-menu rk-footer-menu">
                ...
                <li class="rk-menu__item"><a href="/documentation" class="rk-menu__link">@lang('verimake.portfolio')</a>
                </li>
                <li class="rk-menu__item"><a href="/contact" class="rk-menu__link">@lang('verimake.contactus')</a>
                </li>
            </ul>
            <p class="rk-footer__text rk-footer__copy "> <span class="ae-u-bold">© </span><span class="ae-u-bolder">2017 Verimake </span>All Right Reserved.</p>
        </div>
